          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:items-center">
            ...
            <div className="flex items-center bg-primary-700/50 rounded-lg p-1">
              ...
              >
                ...
                <span className="absolute -top-2 -right-2 bg-accent-500 text-white text-[10px] font-semibold px-1 rounded">
                  beta
                </span>
              </button>
            </div>
          ...
          <div className="hidden lg:block">
            <div className="tooltip">
              <span className="text-sm font-medium cursor-help border-b border-dashed border-white/70">
                About {mode === "single" ? "Individual" : "Couple"}{" "}
                {strategyMode.toUpperCase()}
              </span>
              <span className="tooltip-text w-72">{getTooltipText()}</span>
            </div>
          </div>
        </div>
